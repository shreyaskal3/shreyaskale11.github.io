...
Detail explanation of GPT 60 lines

Input text -> Preprocessing -> Encoder -> Decoder -> Output text

Preprocessing :

[Explanation of Tokenizer and Embedding is here](https://ainotes.in/posts/TokenizationandEmbedding/)
