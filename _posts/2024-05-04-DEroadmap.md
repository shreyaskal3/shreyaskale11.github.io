...
> 1. [Watch the awesome video below to receive a basic introduction to Python and become familiar with its syntax and concepts in 1 Hour - Programming with Mosh](https://www.youtube.com/watch?v=kqtD5dpn9C8)
>
> 2. [Practice as much as possible using W3 Schools](https://www.w3schools.com/python/)
...
> 1. [Watch the video to receive a fundamental introduction to SQL, spending 3 hours to become familiar with its syntax and concepts - Programming with Mosh:](https://www.youtube.com/watch?v=7S_tz1z_5bA ) 
>
> 2. [Practice as much as possible using W3 Schools](https://www.w3schools.com/sql/) 
...
> [Books/Kimball_The-Data-Warehouse-Toolkit-3rd-Edition.pdf](https://www.bing.com/search?q=kimball+the+data+warehouse+toolkit+pdf&qs=UT&pq=kimball+the+data+warehouse+toolkit+&sc=4-35&cvid=43EED73798C64B198D59BA24354CE15D&FORM=QBRE&sp=1&ghc=1&lq=0)
...
> 4. [What is a Fact Table?](https://www.youtube.com/watch?v=hQvCOBv_-LE)  
> 5. [What is a Dimension Table?](https://www.youtube.com/watch?v=hQvCOBv_-LE) 
> 6. [Data Modelling: Star Schema vs Snowflake Schema](https://www.youtube.com/watch?v=hQvCOBv_-LE)
> 7. [Slowly Changing Dimensions (SCD)- Type 1 and Type 2: What is SCD / Slowly Changing Dimension | Data Engineering Tutorial | Data Engineering Concepts - YouTube]() 
> 8. [What is a Data Mart? Data Mart vs Datawarehouse How Data Mart actually works? We are here to show you! - YouTube](https://www.youtube.com/watch?v=kDRwHPxagJc&t=31s) 
> 9. [What is Extract Transform Load (ETL)?](https://www.youtube.com/watch?v=j5HUv8RvuL4&t=3s) (understand the ETL part) 
> 10. [What is a Data Lake? DataLake vs Data Warehouse vs Database KNOW the difference between Data Base // Data Warehouse // Data Lake (Easy 
...
> 2. [Adam Marczak](https://www.youtube.com/watch?v=NPEsD6n9A_I&list=PLGjZwEtPN7jQ59JYso3L4_yoCjj2syrM) 
...
> - [Discussion tab for all the questions](https://www.examtopics.com/exams/microsoft/az-900/) 
...
> - [How to schedule azure exam with Pearson VUE | AZ-900, AI-900, DP-900, SC-900 - YouTube](https://www.youtube.com/watch?v=Zx7FHRVt2cQ)

## Stage 4: Azure Data Tools  

- **Create a Free Azure Account** 

> - [Click Here For Create a 30 Day Free Azure account](https://azure.microsoft.com/en-in/free)
...
- Azure Data Factory (ADF) is a cloud-based Extract, Transform, Load (ETL) tool provided by Microsoft Azure that helps organizations move and transform data from various sources to destinations. Think of it as a data orchestration tool that allows you to create, schedule, and manage ETL data pipelines.
    ...
    > 1. [YT ADF Channel- Mr. K Talks Tech - 10 Videos](https://www.youtube.com/playlist?list=PLrG_BXEk3kXwTClTt3_28CMz2dZoaFhKD)
    > 2. [YT ADF Channel- WafaStudies - 107 Videos](https://www.youtube.com/playlist?list=PLMWaZteqtEaLTJffbbBzVOv9C0otal1FO)
...
- Azure Synapse Analytics is a cloud-based analytics service by Microsoft Azure which offers big data and data warehousing functionalities. The platform offers a unified experience for data professionals, facilitating collaboration and efficient analysis through integrated workspaces and notebooks. 
    ...
    > [YT Azure Synapse Channel - WafaStudies - 59 Videos](https://www.youtube.com/playlist?list=PLMWaZteqtEaIZxPCw_0AO1GsqESq3hZc6)
...
- Resources to learn Azure Databricks 
    ...
    > 1. [YT DataBricks Channel - Raja's Data Engineering - 109 Videos](https://www.youtube.com/playlist?list=PLgPb8HXOGtsQeiFz1y9dcLuXjRh8teQtw) 
    > 2. [YT DataBricks Channel - spark fundamental (Theory) - 26 Videos](https://www.youtube.com/playlist?list=PLTsNSGeIpGnGkpfKMf7ilFmzfx6AjMKyT) 
    > 3. [YT DataBricks Channel - spark practical (DataFrame API) - 25 Videos](https://www.youtube.com/playlist?list=PLTsNSGeIpGnGjaMSYVlidqVWSjKWoBhbr) 
...
> - [Watch the below YT playlist to understand more about Microsoft Fabric:](https://www.youtube.com/playlist?list=PLrG_BXEk3kXybedCIBBI4lmaIbtbn7MdM)
...
> 1. [Microsoft Azure Data Engineer Associate Certification Training](https://www.youtube.com/playlist?list=PL7ZG6NdDdT8NRHDU5shVgGjlua297bm-H)
> 2. [YT playlist - DP-203](https://www.youtube.com/playlist?list=PL-oeM7CaGtVjRgNJ5oy9xbrpcOYr3RhZG)
...
> - [Udemy Playlist](https://www.udemy.com/course/dp200exam/)(Look for offers before buying) 
...
> [Link for Exam Book](https://learn.microsoft.com/en-us/credentials/certifications/exams/dp-203/)
